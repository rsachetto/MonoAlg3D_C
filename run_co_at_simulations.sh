...
INPUT_PATH="/home/berg/Github/MonoAlg3D_C/example_configs/05_Lucas/01_SRN_Purkinje/02_CO_Activation_Time"
...
for SEED in "${SEEDS[@]}"; do
    ...
    ${PROGRAM_PATH} -c ${INPUT_PATH}/co_min\:at_seed-${SEED}_nterm\:650.ini
done
