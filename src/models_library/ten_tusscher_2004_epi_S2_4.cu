...
#include "ten_tusscher_2004_epi_S2_4.h"
...
__global__ void kernel_set_model_inital_conditions(real *sv, int num_volumes)
{
    ...
    */ 
     ...
     // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.5793178722953,0.00128702664782811,0.779977951085919,0.779768950190264,0.000174573024905504,0.485205124660009,0.00293799260898190,0.999998351770336,1.92995511627802e-08,1.88828154782461e-05,0.999770256344097,1.00715825007127,0.999996210733386,4.36879776141090e-05,0.331256127956387,10.3798846138262,139.374031146517};
...
// Setting Elnaz's parameters
    real parameters []={14.3544085292560,0.000184176739030061,0.000116727784773217,0.000529156509214807,0.213021413678697,0.142056006209330,0.110008195863383,4.56874727878451,0.0110355618980506,1.64392976716362,1087.59508291594,0.000351857229131069,0.537011794380979,0.0172863235264215,0.00186493720921700,4.56756039776808e-05};     
     GNa=parameters[0];
     GbNa=parameters[1];
     GCaL=parameters[2];
     GbCa=parameters[3];
