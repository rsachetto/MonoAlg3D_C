#ifndef MONOALG3D_TEN_TUSSCHER_EPI_SCENARIO_2_2_2004_H
#define MONOALG3D_TEN_TUSSCHER_EPI_SCENARIO_2_2_2004_H

// Scenario 2.1 - TenTusscher 2004 (Epicardium)
// Fitting: (AP + max:dvdt + Rc)
#include <stdint.h>
