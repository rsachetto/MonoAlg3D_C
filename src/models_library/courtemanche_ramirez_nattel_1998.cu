...
extern "C" SET_ODE_INITIAL_CONDITIONS_GPU(set_model_initial_conditions_gpu) {
    ...
    log_to_stdout_and_file("Using courtemanche_ramirez_nattel_1998 GPU model\n");
...
inline __device__ void solve_forward_euler_gpu_adpt(real *sv, real stim_curr, real final_time, int thread_id) {
    ...
    #define DT *((real *)((char *)sv + pitch * 21) + thread_id)
    #define TIME_NEW *((real *)((char *)sv + pitch * 22) + thread_id)
    #define PREVIOUS_DT *((real *)((char *)sv + pitch * 23) + thread_id)
