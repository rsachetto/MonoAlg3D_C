...
// T-WAVE PERSONALISATION
//real GKs= 0.0011*IKs_Multiplier;
//real GKs = 0.0011 * (pow(0.2, (2*basetoapex - 1))) * sf_Iks;   // T-wave personalisation
real GKs = 0.0011*sf_Iks;					 // T-wave personalisation
...
real Jrel = 1.5378 * ((1.0-fJrelp)*Jrel_np+fJrelp*Jrel_p)*Jrel_Multiplier;
...
b_[33] = xs1ss / txs1;
b_[34] = xs2ss / txs2;
b_[35] = Jrel_infp / tau_relp;
b_[42] = Jrel_inf / tau_rel;
