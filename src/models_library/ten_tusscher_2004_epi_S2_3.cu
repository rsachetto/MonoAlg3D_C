...
__global__ void kernel_set_model_inital_conditions(real *sv, int num_volumes)
{
    ...
    */ 
     ...
     // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.5155355988227,0.00130464112117661,0.778394151451177,0.777964840660150,0.000176215905240282,0.484540692918688,0.00295140339852797,0.999998329361488,1.95069132761285e-08,1.90441683873891e-05,0.999773668881183,1.00752137726522,0.999999011953414,3.50467870287278e-05,0.552698876142541,10.5362185646449,139.026156778373};
...
// Setting Elnaz's parameters
    real parameters []={14.4104027737061,0.000233793217484143,0.000134103897714886,0.000392835183485183,0.247705661554596,0.185613722097597,0.139724865300249,4.46736215747095,0.0148738820812480,1.45357322782103,1098.78347998281,0.000333024201998587,0.167028470911446,0.0196544238733398,0.00282952210522065,1.25600394920021e-05};     
     GNa=parameters[0];
     GbNa=parameters[1];
     GCaL=parameters[2];
     GbCa=parameters[3];
