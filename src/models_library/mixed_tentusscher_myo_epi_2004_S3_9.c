...
// (AP + max:dvdt + Rc)
#include <stdio.h>
#include "mixed_tentusscher_myo_epi_2004_S3_9.h"
...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) 
{
    ...
    */
        // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.5013992162453,0.00130861673751888,0.778065207799721,0.777945271471961,0.000176364646931449,0.484394446924523,0.00295432941296383,0.999998325858239,1.95514472517084e-08,1.90799805126353e-05,0.999773537725853,1.00682358047437,0.999989828965692,5.15136550864487e-05,0.464168596431909,10.1029140201320,139.520992982978};
for (uint32_t i = 0; i < NEQ; i++)
            sv[i] = sv_sst[i];
    }
}
