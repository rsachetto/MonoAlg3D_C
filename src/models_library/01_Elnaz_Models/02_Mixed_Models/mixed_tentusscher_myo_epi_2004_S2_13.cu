...
__global__ void kernel_set_model_inital_conditions(real *sv, real *IC, uint32_t *mapping, int num_volumes) {
    ...
    if (threadID < num_volumes) {
        ...
        // EPI
            ...
            // Elnaz's steady-state initial conditions
            real sv_sst[]={ -86.5539038753567, 0.00129412448996796, 0.779360292837132, 0.779249119724812, 0.000175123544000358, 0.484940918252471, 0.00294329963917416, 0.999998343965409, 1.93809582696782e-08, 1.89468693200808e-05, 0.999768982807075, 1.00735744125472, 0.999998089726980, 3.89830144793233e-05, 1.72829326331064, 9.02393126594947, 140.110171882154 };
            for (uint32_t i = 0; i < NEQ; i++)
                *((real * )((char *) sv + pitch * i) + threadID) = sv_sst[i];
        }
    }
