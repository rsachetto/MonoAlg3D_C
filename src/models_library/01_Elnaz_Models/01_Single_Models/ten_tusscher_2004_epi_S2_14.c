...
void RHS_cpu(const real *sv, real *rDY_, real stim_current, real dt) {
    ...
    // Changed parameters
    real parameters []={ 13.8459241921870, 0.000196064566156457, 0.000146553942706429, 0.000703301155773898, 0.260161768868762, 0.181317938505467, 0.117372181971868, 3.63855954741155, 0.0150905585683178, 2.46920388142297, 1094.85218851589, 0.000479578430398116, 0.318788483309312, 0.0161958786068848, 0.00436114068069140, 1.30104522530463e-05 };
