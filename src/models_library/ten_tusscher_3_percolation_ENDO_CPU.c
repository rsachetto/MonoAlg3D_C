...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) 
{
    ...
    {
#ifdef _WIN32
        printf("Using ten Tusscher 3 Percolation CPU model\n");
#else
        print_to_stdout_and_file("Using ten Tusscher 3 Percolation CPU model\n");
#endif

        first_call = false;
    }

    // Default initial values from CellML (Original)
    if (extra_data == NULL)
    {
