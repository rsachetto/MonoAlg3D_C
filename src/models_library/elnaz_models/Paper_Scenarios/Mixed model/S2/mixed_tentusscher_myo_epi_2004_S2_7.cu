...
__global__ void kernel_set_model_inital_conditions(real *sv, uint32_t *mapping, int num_volumes) 
{
    ...
    if (threadID < num_volumes) 
    {
        ...
        */
            // Elnaz's steady-state initial conditions
            real sv_sst[]={-86.5108357840011,0.00130598320935367,0.778297936322614,0.778168249814233,0.000176184942496385,0.484492639570884,0.00295234515201219,0.999998328994369,1.95207361603797e-08,1.90559907730747e-05,0.999779205501714,1.00683281960406,0.999990079738075,5.13012060586906e-05,1.20488538387603,8.59982990627790,140.667607494303};            for (uint32_t i = 0; i < NEQ; i++)
                *((real * )((char *) sv + pitch * i) + threadID) = sv_sst[i];
        }
    }
}
...
//Parameters for IpK;
    ...
    real parameters []={13.5180163805163,0.000327758478537637,0.000171474998724435,0.000691830399658185,0.287392821646320,0.166300577201109,0.184041710714562,3.74850836746364,0.0218547235879219,3.15306872250787,1099.99995030167,0.000576388720425406,0.124097096559342,0.0199999709711304,0.00444385627683816,2.41454672727958e-05};
    GNa=parameters[0];
    GbNa=parameters[1];
    GCaL=parameters[2];
    GbCa=parameters[3];
