...
// (AP + max:dvdt + Rc)
#include <stdio.h>
#include "mixed_tentusscher_myo_epi_2004_S3_14.h"
...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) 
{
    ...
    */
        // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.4701623426359,0.00131737146171314,0.777285645576353,0.777040702070568,0.000177302400543810,0.484069084852775,0.00296092534643008,0.999998315282769,1.96540021177560e-08,1.91596517539881e-05,0.999772462962093,1.00714489342282,0.999996044322701,4.40029880716776e-05,0.468228706703227,10.4856074751910,139.137078722658};
for (uint32_t i = 0; i < NEQ; i++)
            sv[i] = sv_sst[i];
    }
}
...
//Parameters for IpK;
    ...
    real parameters []={14.4654760758413,0.000327679551079756,0.000138641371332580,0.000400113528829566,0.262498267716038,0.153103999735652,0.168342892703892,4.79908449960100,0.0143570036406533,1.57081273491899,1099.89828050721,0.000378622728349837,0.292172050936394,0.0184885268398775,0.00254492554570311,3.55949138235335e-05};
    GNa=parameters[0];
    GbNa=parameters[1];
    GCaL=parameters[2];
    GbCa=parameters[3];
