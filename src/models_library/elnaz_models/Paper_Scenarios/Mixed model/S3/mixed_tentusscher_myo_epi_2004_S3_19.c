...
// (AP + max:dvdt + Rc)
#include <stdio.h>
#include "mixed_tentusscher_myo_epi_2004_S3_19.h"
...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) 
{
    ...
    */
        // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.5036583376630,0.00130798579373385,0.778118058687785,0.777933763628425,0.000176452786663980,0.484417830724176,0.00295386094872215,0.999998326603838,1.95442955456924e-08,1.90742511447578e-05,0.999758856242052,1.00681366753249,0.999989553911008,5.17395960161647e-05,0.335484325505905,10.1000454684880,139.647159404278};
for (uint32_t i = 0; i < NEQ; i++)
            sv[i] = sv_sst[i];
    }
}
