...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) 
{
    ...
    */
        // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.5624423262106,0.00129167275470664,0.779566791615456,0.779410913961902,0.000174854203482290,0.485029627881613,0.00294151853152467,0.999998346761065,1.93536430763538e-08,1.89253322511936e-05,0.999770718781989,1.00705290160006,0.999994726153831,4.61702239557613e-05,0.428543055333246,10.5677098069322,139.088209861540};
for (uint32_t i = 0; i < NEQ; i++)
            sv[i] = sv_sst[i];
    }
}
...
//Parameters for IpK;
    ...
    real parameters []={14.4147498667915,0.000251124617142363,0.000137013485769181,0.000169470481210674,0.253895228590867,0.152733305273802,0.167845467014990,4.51645656101753,0.0160856241829014,1.32915393527547,1099.63821888814,0.000521101954310938,0.130615895825142,0.0198817586800201,0.00476047046076979,6.04955465909554e-05};    
    GNa=parameters[0];
    GbNa=parameters[1];
    GCaL=parameters[2];
    GbCa=parameters[3];
