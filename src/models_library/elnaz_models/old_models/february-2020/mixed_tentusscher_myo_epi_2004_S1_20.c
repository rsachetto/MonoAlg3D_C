...
// (AP + max:dvdt)
#include <stdio.h>
#include "mixed_tentusscher_myo_epi_2004_S1_20.h"
...
SET_ODE_INITIAL_CONDITIONS_CPU(set_model_initial_conditions_cpu) 
{
    ...
    */
        // Elnaz's steady-state initial conditions
        real sv_sst[]={-86.5180103766650,0.00130403507538545,0.778471794824763,0.778283525838093,0.000176065618651399,0.484567171933683,0.00295084416213736,0.999998331387518,1.94976417188725e-08,1.90377881905604e-05,0.999769816140066,1.00765120153943,0.999999421011808,3.19432158740013e-05,1.25705353770675,9.77685728583073,139.479930314946};        for (uint32_t i = 0; i < NEQ; i++)
            sv[i] = sv_sst[i];
    }
}
