...
__global__ void kernel_set_model_inital_conditions(real *sv, uint32_t *mapping, int num_volumes) 
{
    ...
    if (threadID < num_volumes) 
    {
        ...
        */
            // Elnaz's steady-state initial conditions
            real sv_sst[]={-86.5775905751090,0.00128750116236230,0.779935933436537,0.779723352637460,0.000174601580517662,0.485187163266569,0.00293835320030002,0.999998351150449,1.93050784561332e-08,1.88871626954558e-05,0.999770189484549,1.00686798673141,0.999990981534461,5.04809778641404e-05,0.633311900953308,9.21356412743337,140.293156217684};            for (uint32_t i = 0; i < NEQ; i++)
                *((real * )((char *) sv + pitch * i) + threadID) = sv_sst[i];
        }
    }
}
...
//Parameters for IpK;
    ...
    real parameters []={13.7252581949953,0.000291452087344709,0.000161170796436720,0.000633934538710454,0.279044052137589,0.174768168776027,0.153544471133922,3.79004728820943,0.0185410078648928,2.75737595448530,1090.40644729057,0.000413513792232501,0.271770874770752,0.0199966759287835,0.00318963944351548,4.77961669240113e-05};
    GNa=parameters[0];
    GbNa=parameters[1];
    GCaL=parameters[2];
    GbCa=parameters[3];
