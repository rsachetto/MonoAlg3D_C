 ...
 */
    ...
    while(cur_time <= finalT)
    {
        ...
        if (purkinje_config)
        {
            ...
            // REACTION: Purkinje
            solve_purkinje_volumes_odes(the_purkinje_ode_solver, the_grid->the_purkinje->number_of_purkinje_cells, cur_time, ode_step, purkinje_stimuli_configs, configs->purkinje_ode_extra_config);
