...
int main() {
    ...
    save_mesh_config->save_mesh(0, 0.0, save_mesh_config, grid,'v');

    refine_grid_cell(grid, grid->first_cell);

    save_mesh_config->save_mesh(1, 1.0, save_mesh_config, grid,'v');

    derefine_grid_cell(grid, grid->first_cell);

    save_mesh_config->save_mesh(2, 2.0, save_mesh_config, grid,'v');
