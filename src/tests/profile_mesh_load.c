...
int main(int argc, char **argv) {
    ...
    printf("CURRENT RUN\n");
    printf("Avg Config time: %ld\n", average_times.config_time);
    printf("Avg Create grid time: %ld\n", average_times.create_grid_time);
    printf("Avg Order grid time: %ld\n", average_times.order_grid_time);
    printf("Avg Init save function time: %ld\n", average_times.init_time);
    printf("Avg Save function time: %ld\n", average_times.save_time);
    printf("Avg End save function time: %ld\n", average_times.end_time);
    printf("Avg Clean grid time: %ld\n", average_times.clean_time);
    printf("Avg Total time: %ld\n", average_times.total_time);
