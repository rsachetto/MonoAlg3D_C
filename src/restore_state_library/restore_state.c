...
RESTORE_STATE (restore_simulation_state) {
    ...
    for(int i = 0; i < num_extra_fn; i++) {
        ((restore_state_fn*)(config->extra_functions[i]))(time_info, config, save_mesh_config, the_grid, the_monodomain_solver, the_ode_solver, the_purkinje_ode_solver, input_dir);
    }
