...
#define INIT_CALC_ECG(name) void name(struct config *config, struct grid *the_grid)
...
#define CALL_INIT_CALC_ECG(config, grid)                                                                                                                       \
    do {                                                                                                                                                       \
        if(config && config->init_function) {                                                                                                                  \
            ((init_calc_ecg_fn *)config->init_function)(config, grid);                                                                                         \
        }                                                                                                                                                      \
    } while(0)
