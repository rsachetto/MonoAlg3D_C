...
#define SAVE_MESH_2(name) EXPORT_FN void name(int iteration_count, real_cpu current_t, real_cpu last_t, struct save_mesh_config *config, struct grid *the_grid, const char scalar_name)

#define SAVE_MESH(name) EXPORT_FN void name(int iteration_count, real_cpu current_t, real_cpu last_t, real dt, struct save_mesh_config *config, struct grid *the_grid)
