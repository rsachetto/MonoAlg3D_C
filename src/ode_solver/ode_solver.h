...
#define SOLVE_MODEL_ODES_CPU(name)                                                                                     \
 void name (struct string_hash_entry *ode_extra_config, real current_t, real dt, real *sv, real *stim_currents, const uint32_t *cells_to_solve, uint32_t num_cells_to_solve,          \
