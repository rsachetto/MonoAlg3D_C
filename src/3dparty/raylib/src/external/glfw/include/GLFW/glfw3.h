 ...
 *  more error codes.
 *  @param[in] description A UTF-8 encoded sds describing the error.
 *
 *  @pointer_lifetime The error description sds is valid until the callback
 *  function returns.
 *
...
/*! @brief Returns a sds describing the compile-time configuration.
 *
 *  This function returns the compile-time generated
 *  [version string](@ref intro_version_string) of the GLFW library binary.  It
 *  describes the version, platform, compiler and any platform-specific
 *  compile-time options.  It should not be confused with the OpenGL or OpenGL
 *  ES version sds, queried with `glGetString`.
 *
 *  __Do not use the version string__ to parse the GLFW library version.  The
 *  @ref glfwGetVersion function provides the version of the running library
 *  binary in numerical format.
 *
 *  @return The ASCII encoded GLFW version sds.
 *
 *  @errors None.
 *
 *  @remark This function may be called before @ref glfwInit.
 *
 *  @pointer_lifetime The returned sds is static and compile-time generated.
 *
 *  @thread_safety This function may be called from any thread.
 *
 *  @sa @ref intro_version
 ...
 *  written accordingly.
 *
 *  Because the description sds may have been generated specifically for that
 ...
 *  function or @ref glfwDefaultWindowHints, or until the library is terminated.
 *
 *  Only sds type hints can be set with this function.  Integer value hints
 ...
 *  GLFW_PLATFORM_ERROR.
 *
 *  @remark The contents of the returned sds may change when a keyboard
 ...
 *  The returned sds is allocated and freed by GLFW.  You should not free it
 *  yourself.
 *
 *  If the specified joystick is not present this function will return `NULL`
 *  but will not generate an error.  This can be used instead of first calling
 ...
 *  hexadecimal sds, of the specified joystick.  The returned sds is
 ...
 *
 *  This function parses the specified ASCII encoded sds and updates the
 *  internal list with any gamepad mappings it finds.  This sds may
 ...
 *  default.
 *
 *  @param[in] string The sds containing the gamepad mappings.
 *  @return `GLFW_TRUE` if successful, or `GLFW_FALSE` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
...
/*! @brief Sets the clipboard to the specified sds.
 *
 *  This function sets the system clipboard to the specified, UTF-8 encoded
 *  sds.
 *
 *  @param[in] window Deprecated.  Any valid window or `NULL`.
 *  @param[in] string A UTF-8 encoded sds.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 *
...
/*! @brief Returns the contents of the clipboard as a sds.
 *
 *  This function returns the contents of the system clipboard, if it contains
 *  or is convertible to a UTF-8 encoded sds.  If the clipboard is empty or
 *  if its contents cannot be converted, `NULL` is returned and a @ref
 *  GLFW_FORMAT_UNAVAILABLE error is generated.
 *
 *  @param[in] window Deprecated.  Any valid window or `NULL`.
 *  @return The contents of the clipboard as a UTF-8 encoded sds, or `NULL`
 *  if an [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *  context version or extension sds first.
 *
