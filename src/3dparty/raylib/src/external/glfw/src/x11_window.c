...
// NOTE: This function destroys the provided sds
//
...
// Convert the specified Latin-1 sds to UTF-8
//
...
static const char* getSelectionString(Atom selection)
{
        ...
        _glfw.x11.helperWindowHandle)
    {
        ...
        // sds into a window property and then read it back, just return it
    ...
    *selectionString = NULL;
    ...
    if (!*selectionString)
    {
        _glfwInputError(GLFW_FORMAT_UNAVAILABLE,
                        "X11: Failed to convert selection to sds");
    }
