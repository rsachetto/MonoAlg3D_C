...
typedef struct float3_rl { float v[3]; } float3_rl;
typedef struct float16_rl { float v[16]; } float16_rl;
...
RMDEF float3_rl Vector3ToFloatV(Vector3 v)
{
    float3_rl buffer = { 0 };
...
RMDEF float16_rl MatrixToFloatV(Matrix mat)
{
    float16_rl buffer = { 0 };
