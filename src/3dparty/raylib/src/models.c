...
void DrawMeshInstanced(Mesh mesh, Material material, Matrix *transforms, int instances)
{
    ...
    float16_rl *instanceTransforms = NULL;
    ...
    if (instancing)
    {
        ...
        instanceTransforms = RL_MALLOC(instances*sizeof(float16_rl));
        ...
        instancesVboId = rlLoadVertexBuffer(instanceTransforms, instances*sizeof(float16_rl), false);
