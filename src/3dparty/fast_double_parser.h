...
really_inline struct value128 full_multiplication(uint64_t value1, uint64_t value2) {
...
inline static int leading_zeroes(uint64_t input_num) {
#ifdef _MSC_VER
...
really_inline static double compute_float_64(int64_t power, uint64_t i, bool negative,
                                      bool *success) {
