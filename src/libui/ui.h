...
_UI_EXTERN void uiHandlePendingEvents();
...
_UI_EXTERN void uiWindowSetModal(uiWindow *w, uiWindow *parent, int modal);
...
typedef struct uiSourceView uiSourceView;
#define uiSourceView(this) ((uiSourceView *) (this))
...
_UI_EXTERN int uiMsgBoxConfirmCancel(uiWindow *parent, const char *title, const char *description);
