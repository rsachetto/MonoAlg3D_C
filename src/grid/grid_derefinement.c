...
bool derefine_grid_with_bound(struct grid *the_grid, double derefinement_bound, double max_h) {
    ...
    long int bunch_number1, bunch_number2, bunch_number3, bunch_number4, bunch_number5,
        bunch_number6, bunch_number7, bunch_number8;
            ...
            if ((active1) && (active2) && (active3) && (active4) && (active5) && (active6) &&
                ...
                if ((grid_cell->next != 0 && grid_cell->next->can_change) &&
                    ...
                    if ((grid_cell->cell_data.level == grid_cell->next->cell_data.level) &&
                        ...
                        (grid_cell->cell_data.level ==
                         grid_cell->next->next->next->cell_data.level) &&
                        (grid_cell->cell_data.level ==
                         grid_cell->next->next->next->next->cell_data.level) &&
                        (grid_cell->cell_data.level ==
                         grid_cell->next->next->next->next->next->cell_data.level) &&
                        (grid_cell->cell_data.level ==
                         grid_cell->next->next->next->next->next->next->cell_data.level) &&
                        (grid_cell->cell_data.level ==
                         grid_cell->next->next->next->next->next->next->next->cell_data.level)) {
                        ...
                        bunch_number7 =
                            grid_cell->next->next->next->next->next->next->bunch_number / 10;
                        bunch_number8 =
                            grid_cell->next->next->next->next->next->next->next->bunch_number / 10;
...
void derefine_all_grid (struct grid* the_grid) {
    ...
    while (grid_cell != 0) {
        ...
        if (grid_cell->cell_data.level > 1) {
            ...
            if ((grid_cell->next != 0) && (grid_cell->next->next != 0) &&
                (grid_cell->next->next->next != 0) && (grid_cell->next->next->next->next != 0) &&
                (grid_cell->next->next->next->next->next != 0) &&
                (grid_cell->next->next->next->next->next->next != 0) &&
                (grid_cell->next->next->next->next->next->next->next != 0)) {
                /* Verifies if each one of the next seven  cells  has  the  same
 ...
 */
void derefine_first_bunch (struct grid *the_grid) {
    struct cell_node *grid_cell, *auxiliar_grid_cell;
    ...
    bool has_been_derefined = false;
        ...
        while ((grid_cell != 0) && (!has_been_derefined)) {
            ...
            if (grid_cell_level > 1) {
                ...
                if ((grid_cell->next != 0) && (grid_cell->next->next != 0) &&
                    ...
                    if ((grid_cell_level == grid_cell->next->cell_data.level) &&
                        ...
                        bunch_number1 = grid_cell->bunch_number / (int)10;
                        bunch_number2 = grid_cell->next->bunch_number / (int)10;
                        bunch_number3 = grid_cell->next->next->bunch_number / (int)10;
                        bunch_number4 = grid_cell->next->next->next->bunch_number / (int)10;
                        bunch_number5 = grid_cell->next->next->next->next->bunch_number / (int)10;
                        bunch_number6 =
                            grid_cell->next->next->next->next->next->bunch_number / (int)10;
                        bunch_number7 =
                            grid_cell->next->next->next->next->next->next->bunch_number / (int)10;
                        bunch_number8 =
                            grid_cell->next->next->next->next->next->next->next->bunch_number /
                            (int)10;
                        if ((bunch_number1 == bunch_number2) && (bunch_number1 == bunch_number3) &&
                            (bunch_number1 == bunch_number4) && (bunch_number1 == bunch_number5) &&
                            (bunch_number1 == bunch_number6) && (bunch_number1 == bunch_number7) &&
...
void derefine_grid_inactive_cells (struct grid* the_grid) {
    ...
    unsigned long long int bunch_number1, bunch_number2, bunch_number3, bunch_number4,
        bunch_number5, bunch_number6, bunch_number7, bunch_number8;
