...
def main ():
    if ( len(sys.argv) != 7 ):
        ...
        print("-------------------------------------------------------------------------------------------------------------")
        print("Example:> python %s aps/ap-fhn-4aps-cell-1000 4 250 1 100 90" % (sys.argv[0]))
        print("          python %s aps/ap-fhn-cell-1000.txt 1 250 2 100 90" % (sys.argv[0]))
        print("          python %s aps/ap-tt-cell-1000.txt 1 500 2 100 90" % (sys.argv[0]))
        print("-------------------------------------------------------------------------------------------------------------")
        return 1
