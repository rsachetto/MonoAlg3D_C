...
void free_purkinje_network (struct purkinje_network *the_purkinje_network)
{
    if (the_purkinje_network->lines)
        free(the_purkinje_network->lines);
    if (the_purkinje_network->points)
        free(the_purkinje_network->points);
    if (the_purkinje_network->point_data)
        free(the_purkinje_network->point_data);
    free(the_purkinje_network);
}
