...
def main ():
    if ( len(sys.argv) != 8 ):
        print("-------------------------------------------------------------------------------------------------------------")
        print("Usage:> python %s <output_dir> <num_aps> <period> <ms_each_step> <total_num_cells>" % sys.argv[0])
        ...
        print("-------------------------------------------------------------------------------------------------------------")
        print("Example:> python calc_apd_full_grid.py ../../outputs/plain_100_100_100_fhn 1 250 2 10000 100 90")
        print("          python calc_apd_full_grid.py ../../outputs/plain_100_100_100_tentusscher 1 500 2 10000 100 90")
        print("-------------------------------------------------------------------------------------------------------------")
        return 1
    ...
    APD_percentage = float(sys.argv[7])
    ...
    out_file.close()
    print("[+] Output file saved in 'output/cell-apd.txt'")
