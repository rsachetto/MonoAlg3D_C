...
RAYGUIAPI bool GuiSpinner(Rectangle bounds, const char *text, float *value, float minValue, float maxValue, bool intVal, bool editMode);     // Spinner control, returns selected value
RAYGUIAPI bool GuiValueBox(Rectangle bounds, const char *text, float *value, float minValue, float maxValue, bool intVal, bool editMode);    // Value Box control, updates input text with numbers
...
bool GuiSpinner(Rectangle bounds, const char *text, float *value, float minValue, float maxValue, bool intVal, bool editMode)
{
    GuiControlState state = guiState;
    ...
    pressed = GuiValueBox(spinner, NULL, &tempValue, minValue, maxValue, intVal, editMode);
...
bool GuiValueBox(Rectangle bounds, const char *text, float *value, float minValue, float maxValue, bool intVal, bool editMode)
{
