...
int main(int argc, char **argv) {
    ...
    for(int i = 0; i < nruns; i++) {
        ...
        struct vtk_unstructured_grid *vtk_grid = new_vtk_unstructured_grid_from_file("tests_bin/profile_mesh_load.alg", true);
    ...
    f = gdbm_open( "./tests_bin/profile_alg_load_times.gdbm", 4096, GDBM_WRCREAT, 0644, NULL );
