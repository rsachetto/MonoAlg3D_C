...
// INCX
real INCX = GNCX * INCX_bar * (exp(INCX_gamma * FoRT * Vm) * Nai * Nai * Nai * Cao - exp((INCX_gamma - 1) * FoRT * Vm) * Nao * Nao * Nao * Cai) /
            ((pow(INCX_kNao, 3) + Nao * Nao * Nao) * (INCX_kCao + Cao) * (1 + INCX_k * exp((INCX_gamma - 1) * FoRT * Vm)));
