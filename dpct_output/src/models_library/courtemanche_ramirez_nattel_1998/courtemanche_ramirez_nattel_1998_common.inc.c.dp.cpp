...
#define IFNUMBER_11(name)if((fabs((V_old_-7.900000000000000e+00))<1.000000000000000e-10)) { (name) = ((6.000000000000000e+00*2.000000000000000e-01)/1.300000000000000e+00);    }  else{ (name) = ((6.000000000000000e+00*(1.000000000000000e+00-exp(((-(V_old_-7.900000000000000e+00))/5.000000000000000e+00))))/((1.000000000000000e+00+(3.000000000000000e-01*exp(((-(V_old_-7.900000000000000e+00))/5.000000000000000e+00))))*1.000000000000000e+00*(V_old_-7.900000000000000e+00)));    }    //Parameters
    ...
    real calc_oi_infinity = pow((1.000000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) + 3.310000000000000e+01) / 5.300000000000000e+00))),
                                (-1.000000000000000e+00)); // 30
    ...
    real calc_ui_infinity = pow((1.000000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) - 1.094500000000000e+02) / 2.748000000000000e+01))),
                                (-1.000000000000000e+00)); // 42
    ...
    real calc_tau_f = (9.000000000000000e+00 * pow(((1.970000000000000e-02 * exp(((-pow(3.370000000000000e-02, 2.000000000000000e+00)) *
                                                                                  pow((V_old_ + 1.000000000000000e+01), 2.000000000000000e+00)))) +
    ...
    real calc_w_infinity = (1.000000000000000e+00 -
                            pow((1.000000000000000e+00 + exp(((-(V_old_ - 4.000000000000000e+01)) / 1.700000000000000e+01))), (-1.000000000000000e+00))); // 84
