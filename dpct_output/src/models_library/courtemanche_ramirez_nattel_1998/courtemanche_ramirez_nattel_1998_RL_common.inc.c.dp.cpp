...
real calc_alpha_oa = (6.500000000000000e-01 * pow((exp(((V_old_ - (-1.000000000000000e+01)) / (-8.500000000000000e+00))) +
                                                   exp((((V_old_ - (-1.000000000000000e+01)) - 4.000000000000000e+01) / (-5.900000000000000e+01)))),
                                                  (-1.000000000000000e+00))); // 22
real calc_beta_oa =
    (6.500000000000000e-01 * pow((2.500000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) + 7.200000000000000e+01) / 1.700000000000000e+01))),
                                 (-1.000000000000000e+00))); // 23
real calc_oa_infinity = pow((1.000000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) + 1.047000000000000e+01) / (-1.754000000000000e+01)))),
                            (-1.000000000000000e+00)); // 25
real calc_alpha_oi =
    pow((1.853000000000000e+01 + (1.000000000000000e+00 * exp((((V_old_ - (-1.000000000000000e+01)) + 1.037000000000000e+02) / 1.095000000000000e+01)))),
        (-1.000000000000000e+00)); // 27
real calc_beta_oi =
    pow((3.556000000000000e+01 + (1.000000000000000e+00 * exp((((V_old_ - (-1.000000000000000e+01)) - 8.740000000000000e+00) / (-7.440000000000000e+00))))),
        (-1.000000000000000e+00)); // 28
real calc_oi_infinity =
    pow((1.000000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) + 3.310000000000000e+01) / 5.300000000000000e+00))), (-1.000000000000000e+00)); // 30
...
real calc_alpha_ua = (6.500000000000000e-01 * pow((exp(((V_old_ - (-1.000000000000000e+01)) / (-8.500000000000000e+00))) +
                                                   exp((((V_old_ - (-1.000000000000000e+01)) - 4.000000000000000e+01) / (-5.900000000000000e+01)))),
                                                  (-1.000000000000000e+00))); // 34
real calc_beta_ua =
    (6.500000000000000e-01 * pow((2.500000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) + 7.200000000000000e+01) / 1.700000000000000e+01))),
                                 (-1.000000000000000e+00))); // 35
real calc_ua_infinity = pow((1.000000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) + 2.030000000000000e+01) / (-9.600000000000000e+00)))),
                            (-1.000000000000000e+00)); // 37
real calc_alpha_ui =
    pow((2.100000000000000e+01 + (1.000000000000000e+00 * exp((((V_old_ - (-1.000000000000000e+01)) - 1.950000000000000e+02) / (-2.800000000000000e+01))))),
        (-1.000000000000000e+00));                                                                                                      // 39
real calc_beta_ui = (1.000000000000000e+00/exp((((V_old_-(-1.000000000000000e+01))-1.680000000000000e+02)/(-1.600000000000000e+01))));	//40
real calc_ui_infinity =
    pow((1.000000000000000e+00 + exp((((V_old_ - (-1.000000000000000e+01)) - 1.094500000000000e+02) / 2.748000000000000e+01))), (-1.000000000000000e+00)); // 42
...
real calc_tau_f =
    (9.000000000000000e+00 *
     pow(((1.970000000000000e-02 * exp(((-pow(3.370000000000000e-02, 2.000000000000000e+00)) * pow((V_old_ + 1.000000000000000e+01), 2.000000000000000e+00)))) +
          2.000000000000000e-02),
         (-1.000000000000000e+00)));                                                                                    // 61
...
real calc_i_NaCa = ((Cm * I_NaCa_max *
                     ((exp(((gamma * F * V_old_) / (R * T))) * pow(Na_i_old_, 3.000000000000000e+00) * Ca_o) -
                      (exp((((gamma - 1.000000000000000e+00) * F * V_old_) / (R * T))) * pow(Na_o, 3.000000000000000e+00) * Ca_i_old_))) /
                    ((pow(K_mNa, 3.000000000000000e+00) + pow(Na_o, 3.000000000000000e+00)) * (K_mCa + Ca_o) *
                     (1.000000000000000e+00 + (K_sat * exp((((gamma - 1.000000000000000e+00) * V_old_ * F) / (R * T))))))); // 73
...
real calc_w_infinity =
    (1.000000000000000e+00 - pow((1.000000000000000e+00 + exp(((-(V_old_ - 4.000000000000000e+01)) / 1.700000000000000e+01))), (-1.000000000000000e+00))); // 84
...
real calc_B2 = (1.000000000000000e+00 + ((TRPN_max * Km_TRPN) / pow((Ca_i_old_ + Km_TRPN), 2.000000000000000e+00)) +
                ((CMDN_max * Km_CMDN) / pow((Ca_i_old_ + Km_CMDN), 2.000000000000000e+00))); // 99
...
real calc_f_NaK = pow((1.000000000000000e+00 + (1.245000000000000e-01 * exp((((-1.000000000000000e-01) * F * V_old_) / (R * T)))) +
                       (3.650000000000000e-02 * calc_sigma * exp((((-F) * V_old_) / (R * T))))),
                      (-1.000000000000000e+00));    // 67
...
real calc_i_NaK =
    ((((Cm * i_NaK_max * calc_f_NaK * 1.000000000000000e+00) / (1.000000000000000e+00 + pow((Km_Na_i / Na_i_old_), 1.500000000000000e+00))) * K_o) /
     (K_o + Km_K_o)); // 68
...
real calc_tau_v =
    (1.910000000000000e+00 + (2.090000000000000e+00 * pow((1.000000000000000e+00 + exp(((-(calc_Fn - 3.417500000000000e-13)) / 1.367000000000000e-15))),
                                                          (-1.000000000000000e+00)))); // 80
real calc_v_infinity = (1.000000000000000e+00 -
                        pow((1.000000000000000e+00 + exp(((-(calc_Fn - 6.834999999999999e-14)) / 1.367000000000000e-15))), (-1.000000000000000e+00))); // 81
...
rDY[18] = (calc_B1/calc_B2);
rDY[19] = (calc_i_up-(calc_i_up_leak+((calc_i_tr*calc_V_rel)/calc_V_up)));
rDY[20] = ((calc_i_tr - calc_i_rel) *
           pow((1.000000000000000e+00 + ((CSQN_max * Km_CSQN) / pow((Ca_rel_old_ + Km_CSQN), 2.000000000000000e+00))), (-1.000000000000000e+00)));
