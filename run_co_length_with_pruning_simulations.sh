...
INPUT_PATH="/home/berg/Github/MonoAlg3D_C/example_configs/05_Lucas/01_SRN_Purkinje/04_CO_Length_With_Pruning"
...
for SEED in "${SEEDS[@]}"; do
    ...
    ${PROGRAM_PATH} -c ${INPUT_PATH}/co_min\:length_with_pruning_seed-${SEED}_nterm\:650.ini
done
